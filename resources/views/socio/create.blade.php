		...
		<div id="collapseUno" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingUno">
			<div class="panel-body">
				...
				<div class="form-group">
					...
					{!! Form::select('genero',  $genero, null, ['class' => 'form-control', 'placeholder' => 'Elija un genero']) !!}
				</div>

				<div class="form-group">
					{!! Form::label('profesion', 'Profesi&oacute;n') !!}
					{!! Form::select('profesion', $profesion, null, ['class' => 'form-control', 'placeholder' => 'Elija una profesi&oacute;n']) !!}
				</div>
				
				<div class="form-group">
					{!! Form::label('estadoCivil', 'Estado Civil') !!}
					{!! Form::select('estadoCivil', $estadoCivil, null, ['class' => 'form-control', 'placeholder' => 'Elija un estado civil']) !!}
				</div>

				<div class="form-group">
					{!! Form::label('tipoResponsable', 'Tipo Responsable') !!}
					{!! Form::select('tipoResponsable', $tipoResponsable, null, ['class' => 'form-control', 'placeholder' => 'Elija tipo responsable']) !!}
				</div>
